...
export const fetchRouteRequest = createAction('LOFT-TAXI/ROUTES/ROUTE_REQUEST');
export const fetchRouteSuccess = createAction('LOFT-TAXI/ROUTES/ROUTE_SUCCESS');
export const fetchRouteFailure = createAction('LOFT-TAXI/ROUTES/ROUTE_FAILURE');
